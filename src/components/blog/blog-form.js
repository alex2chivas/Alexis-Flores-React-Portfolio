...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://alexisflores.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  deleteImage(imageType){
    axios.delete(`https://alexisflores.devcamp.space/portfolio/delete-portfolio-blog-image/${this.props.blog.id}?image_type=${imageType}`, //Note //Most API will let you had a question mark so you can add addtional information)
    {
  ...
  componentWillMount () {
    if(this.props.editMode) {
      this.setState({
        ...
        // Make sure we throw in the content
        content: this.props.blog.content,
        apiUrl: `https://alexisflores.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
