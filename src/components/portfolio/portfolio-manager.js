...
export default class PortfolioManager extends Component {
	...
	getPortfolioitems() {
		axios
			.get(
				'https://alexisflores.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc', // NOTES // it has ? for different parameters, optional parameters differ per API
				{
					withCredentials: true
				}
			)
